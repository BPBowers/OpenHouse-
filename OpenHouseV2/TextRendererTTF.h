...
{
    GLfloat x;  ///< X screen coordinate for the point.
    GLfloat y;  ///< Y screen coordinate for the point.
    GLfloat s;  ///< X texture coordinate for point.
    GLfloat t;  ///< Y texture coordinate for point.
};
...
{
private:
    GLuint ScreenWidth;       ///< Width of the graphics window.
    GLuint ScreenHeight;      ///< Height of the graphics window.
...
public:
    ...
    void draw(std::string text, GLuint xpos, GLuint ypos, GLfloat rot = 0);
    void draw(const char* text, GLuint xpos, GLuint ypos, GLfloat rot = 0);
};
